 ...
 */
	var PopularView = function(opts) {
		...
		client.get({ network: 'client-solutions.fyre.co', tag: 'heatindex' }, function (err, response) {
	 ...
	 */
	PopularView.prototype._getHeat = function() {
		var delimeter = "?";
	 ...
	 * @param {Object} data
	 */
	PopularView.prototype._getContent = function(data) {
	 ...
	 * @param {Object} data
	 */
	PopularView.prototype._setContent = function(data) {
	...
	PopularView.prototype._truncateTitle = function(data) {
